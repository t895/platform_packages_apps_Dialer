...
public class PreCallCoordinatorImpl implements PreCallCoordinator {
  ...
  void onCreate(Intent intent, @Nullable Bundle savedInstanceState) {
    ...
    if (savedInstanceState != null) {
      ...
      builder = Assert.isNotNull(savedInstanceState.getParcelable(PreCallCoordinator.EXTRA_CALL_INTENT_BUILDER));
    } else {
      builder = Assert.isNotNull(intent.getParcelableExtra(PreCallCoordinator.EXTRA_CALL_INTENT_BUILDER));
    }
    uiListener =
  ...
  void onRestoreInstanceState(Bundle savedInstanceState) {
    currentActionIndex = savedInstanceState.getInt(SAVED_STATE_CURRENT_ACTION);
    builder = savedInstanceState.getParcelable(PreCallCoordinator.EXTRA_CALL_INTENT_BUILDER);
  }
  ...
  void onSaveInstanceState(Bundle outState) {
    ...
    outState.putParcelable(PreCallCoordinator.EXTRA_CALL_INTENT_BUILDER, builder);
  }
